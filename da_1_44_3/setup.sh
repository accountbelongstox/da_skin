...
if [ "$CMD_LINE" -eq 1 ]; then
	...
	echo "*   The Valentine's Day gift for my BF Tianji";
	echo "*   Compiled for CentOS 5 32-Bit";
	echo "*   For 64-Bit Please yum install openssl098e glibc.i686 libstdc++.i686";
	echo "*   For CentOS6 Please link libssl.so.6 and libcrypto.so.6";
	echo "*   For Details see http://dwz.cn/1443tianji";
	echo "*";
	echo "*";
...
if [ $PERL -eq 0 ]; then
	case "$OS_VER" in
		5.3|5.4|5.5|5.6|5.7|5.8|5.9|6.0|6.1|6.2|6.3|6.4|6.5|7|7.0|7.1|7.2|7.3|7.4|7.5|8|8.0|8.1|8.2|8.3)	addPackage perl "$perl";
			;;
